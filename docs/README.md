...
> - **Strategic Documents**: [TRL 4 HIL Plan](trl4_validation_plan.md) | [MeitY Proposal](MEITY_GRANT_PITCH.md) | [Venture Pitch Deck](PITCH_DECK.md) | [Executive Summary](EXECUTIVE_SUMMARY.md) | [Core Theses](THESES.md)
...
*   **[`/docs`](.) (Strategic & Pitch Documents):**
    ...
    *   [PITCH_DECK.md](PITCH_DECK.md) — Commercial Venture Pitch (Slide 13 Doctrine Aligned)
    *   [MEITY_GRANT_PITCH.md](MEITY_GRANT_PITCH.md) — MeitY Government of India Grant Proposal
    *   [BUSINESS_MODEL_CANVAS.md](BUSINESS_MODEL_CANVAS.md) — Strategic Business Framework
    *   [LEAN_CANVAS.md](LEAN_CANVAS.md) — Lean Startup Modeling
    *   [EXECUTIVE_SUMMARY.md](EXECUTIVE_SUMMARY.md) — Core Value Proposition & Summary
    *   [THESES.md](THESES.md) — Core Intellectual Moats & Scientific Claims
    *   [trl4_validation_plan.md](trl4_validation_plan.md) — iDEX 12-Week HIL Lab Validation Plan [NEW]
    *   [spaceshield_proposal.tex](spaceshield_proposal.tex) — LaTeX Technical Pitch Proposal [NEW]
*   **[`/src`](../src) (Core Development):**
    *   [rf_threat_simulator.py](../src/rf_threat_simulator.py) — Real-time signal generator, GLR test statistic engine, and RFF classifier
